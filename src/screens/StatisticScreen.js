...
export default StatisticScreen = () => {
  ...
  const reallyGoodWeek = require('./images/reallyGood.png');
  const goodWeek = require('./images/good.png');
  const okayWeek = require('./images/okay.png');
  const mehWeek = require('./images/meh.png');
  const badWeek = require('./images/bad.png');
  const reallyBadWeek = require('./images/reallyBad.png');
  let imageURL ="";
  let imageWeek ="";
  let imageMonth = "";
